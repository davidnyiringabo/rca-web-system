        ...
        <div className="w-full px-9">
            ...
            <div className="w-full flex-col flex md:flex-row">
                <div className="w-full md:w-3/5 flex flex-col justify-between">
                    <p className="leading-[2rem] w-full">Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremquelaudantium, totam rem aperiam, eaque ipsa quae ab illo inventore veritatis et Quasi architecto beatae vitae dicta sunt explicabo. Quis nostrud kemmith exercitation ullamco laboris nisi ut aliquip.</p>
