const Academics = ()=>{
    return(
        <div className="flex h-[110vh] w-full flex-col pl-9">
            ...
            <p className="leading-[2rem]">All those activities are organized by students but supported and monitored by the school. RCA isn’t only about coding, students get enjoy their academic experience and relax at the same time.</p>
