                                ...
                                {students.map((student, index) => (
                                        ...
                                        >
                                                ...
                                                <td className="p-2 flex flex-row justify-center gap-2">
                                                        <svg xmlns="http://www.w3.org/2000/svg" width="21" height="18" viewBox="0 0 21 18" fill="none" className='cursor-pointer'>
                                                        ...
                                                        <svg width="19" height="19" viewBox="0 0 19 19" xmlns="http://www.w3.org/2000/svg" fill="none" className='cursor-pointer'>
                                                        ...
                                                        <svg xmlns="http://www.w3.org/2000/svg" width="19" height="19" viewBox="0 0 19 19" fill="none" className='cursor-pointer'>
